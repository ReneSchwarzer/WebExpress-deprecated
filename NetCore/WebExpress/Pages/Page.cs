...
namespace WebExpress.Pages
{
    public abstract class Page : IPage
    {
        ...
        /// </summary>
        public List<string> HeaderScriptLink { get; set; }

        /// <summary>
        /// Liefert oder setzt die Links auf die zu verwendenden JavaScript-Dateien
        /// </summary>
        private List<string> ScriptLink { get; set; }
        ...
        public Page()
        {
            ...
            HeaderScriptLink = new List<string>();
            ScriptLink = new List<string>();
            HeaderScripts = new List<string>();
            Scripts = new Dictionary<string, string>();
            CssLink = new List<string>();

            Meta = new List<KeyValuePair<string, string>>
            {
                new KeyValuePair<string, string>("charset", "UTF-8"),
                new KeyValuePair<string, string>("viewport", "width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no")
            };
        }
        ...
        {
            var v = 0;
            if (int.TryParse(GetParam(name), out v))
            {
                return v;
            }
        ...
        {
            return GetUrl((int?)null, extention);
        }
