...
{
    public class WebExSegmentDoubleAttribute : Attribute, IResourceAttribute, ISegmentAttribute
    {
        /// <summary>
        ...
        public WebExSegmentDoubleAttribute(string variableName, string display)
        {
