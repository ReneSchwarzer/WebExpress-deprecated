...
{
    public class WebExSegmentUIntAttribute : Attribute, IResourceAttribute, ISegmentAttribute
    {
        /// <summary>
        ...
        public WebExSegmentUIntAttribute(string variableName, string display)
        {
