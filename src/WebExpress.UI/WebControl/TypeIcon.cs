    ...
    public static class TypeIconExtensions
    {
        ...
        public static string ToClass(this TypeIcon icon)
        {
            return icon switch
            {
                ...
                TypeIcon.BookOpen => "fas fa-book-open",
                ...
                TypeIcon.FileExport => "fas fa-file-export",
                TypeIcon.FileImport => "fas fa-file-import",
                TypeIcon.FileMedicalAlt => "fas fa-file-medical-alt",
