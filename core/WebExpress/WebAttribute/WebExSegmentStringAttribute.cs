...
{
    public class WebExSegmentStringAttribute : Attribute, IResourceAttribute, ISegmentAttribute
    {
        /// <summary>
        ...
        public WebExSegmentStringAttribute(string variableName, string display)
        {
