...
{
    public class WebExSegmentIntAttribute : Attribute, IResourceAttribute, ISegmentAttribute
    {
        /// <summary>
        ...
        public WebExSegmentIntAttribute(string variableName, string display)
        {
