namespace WebExpress.UI.WebAttribute
{
    ...
    /// </summary>
    public enum WebExSettingSection
    {
        /// <summary>
        /// Liefert oder setzt den Preferences-Bereich
        /// </summary>
        Preferences,

        /// <summary>
        /// Liefert oder setzt den Primary-Bereich
        /// </summary>
        Primary,

        /// <summary>
        /// Liefert oder setzt den Secondary-Bereich
        /// </summary>
        Secondary
    }
}
